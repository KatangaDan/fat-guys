...
async function init() {
  return new Promise(async (resolve, reject) => {
    ...
    const cylinder1 = await createHorizontalCylinder(scene, -20, 0, 65, 2, 40);
    const cylinder2 = await createHorizontalCylinder(scene, 0, 0, 65, 2, 40);
    const cylinder3 = await createHorizontalCylinder(scene, 20, 0, 65, 2, 40);
    ...
    //   //Ground pieces for second set of obstacles
      ...
      await createGroundPiece(0, 0, 140, 60, 10);
      await createGroundPiece(0, 0, 165, 60, 10);
      await createGroundPiece(0, 0, 190, 60, 10);
      await createGroundPiece(0, 0, 215, 60, 10);
      await createGroundPiece(0, 0, 240, 60, 10);
