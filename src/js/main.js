  ...
  function checkIdleState() {
    ...
    if (!moveForward && !moveBackward && !moveRight && !moveLeft && currentAction !== idleAction && !isJumping && playerBody.position.y > 0) {
  ...
  function updateMovement(delta) {
    ...
    const isMoving = moveForward || moveBackward || moveLeft || moveRight || isJumping;
    ...
    if (isMoving) {
      ...
      else if (isJumping && !moveForward && !moveBackward && !moveLeft && !moveRight) {
